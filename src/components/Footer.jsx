export default function Footer() {
  return (
    <div className="w-full h-screen px-20 py-10 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading uppercase font-founders text-[9vw] leading-[6.8vw]">
          <h1>Eye-</h1>
          <h1>Opening</h1>
        </div>
        <svg
      ...
      <div className="w-1/2 flex flex-col gap-10">
        <h1 className="uppercase font-founders text-[9vw] leading-[6.8vw]">
          Presentations
        </h1>
        <div className="socials flex flex-col gap-5 font-neuemontreal text-[17.0667px]">
          S:
          <div>
            {["Instagram", "Facebook", "LinkedIn"].map((platform, index) => (
              <a
                className="block font-neuemontreal text-[17.0667px]"
                key={index}
